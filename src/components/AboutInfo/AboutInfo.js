    ...
    <section className={classes.aboutInfo}>
      <Container className={classes.bigCont}>
        <Box className={classes.boxLeft}>
          ...
          <Typography variant="body1" className={classes.paraSm}>
            BiCoin is a multi-functional platform which allows each participant
            to keep money in a multi-currency online wallet, buy and sell
            currency on the exchange, invest money, get a loan in a convenient
            currency.
          </Typography>
